...
public class MainActivity extends AppCompatActivity {
    ...
    {
        Intent entryf = new Intent(getApplicationContext(),firstActivity.class);

        startActivity(entryf);
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] texts = {"All resources at one place","Easy Access to Study Material","Access to all Contacts","One Tap WEB KIOSK"};
